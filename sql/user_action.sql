create
database if not exists profile comment "use action" location '/user/hive/warehouse/profile.db/';
use
profile;
...
(
    ...
    param           struct< action :STRING,
    userId:STRING,
    postId:STRING,
    algorithmCombine:STRING> comment "action parameter"
...
create
external table user_profile_hbase(
